<div>
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Buat Praktikum Baru</h1>
            <p class="text-gray-500 text-sm mt-1">Tambahkan skenario studi kasus PBL baru.</p>
        </div>
    </div>
        ...
        <form wire:submit.prevent="simpan" class="p-6 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="judul" wire:model="judul" placeholder="Contoh: Praktikum Desain Jaringan Kantor Cabang" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
                ...
                <textarea id="studi_kasus" wire:model="studi_kasus" rows="12" placeholder="Ceritakan skenario atau masalah jaringan yang harus dipecahkan murid..." class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 font-mono text-sm leading-relaxed"></textarea>
                <p class="text-xs text-gray-500 mt-1">Gunakan Markdown. Skenario ini akan muncul di bagian atas sebelum murid mengerjakan soal.</p>
