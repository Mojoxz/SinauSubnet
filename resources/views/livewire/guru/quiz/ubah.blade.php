<div>
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Ubah Quiz</h1>
            <p class="text-gray-500 text-sm mt-1">Perbarui pengaturan ujian dan batasan kuis ini.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <form wire:submit.prevent="simpan" class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea id="deskripsi" wire:model="deskripsi" rows="4" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 font-mono text-sm"></textarea>
